...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
      <section className="relative min-h-screen flex items-center pt-20 pb-10 overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center bg-[#2d8b3f]/10 text-[#2d8b3f] px-4 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-lg lg:text-xl font-extrabold mb-6 sm:mb-8 border-2 border-[#2d8b3f]/20 shadow-md min-h-[44px] sm:min-h-[56px] tracking-tight">
                <Typewriter
                  options={{
                    strings: [
                      'Premium Waterless Car Care',
                      'Eco-Friendly Cleaning Solutions',
                      'Showroom Shine at Your Doorstep',
                      'Saving Water, One Car at a Time'
                    ],
                    autoStart: true,
                    loop: true,
                    deleteSpeed: 30,
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-[#2d2d2d] mb-6 leading-tight">
                Waterless
                <br />
              ...
              <div className="flex flex-wrap gap-4">
                <Link to="/book">
                  <Button className="bg-[#2d8b3f] hover:bg-[#236b31] text-white px-8 py-6 text-lg font-semibold rounded-full">
                    Book Now
              ...
              <div className="mt-8 flex flex-col sm:flex-row sm:items-stretch gap-4 sm:gap-6">
                <div className="flex flex-col gap-2 justify-center">
                  ...
                  >
                    <Phone size={18} />
                    <span className="font-medium">Uday: +91 8160057141</span>
                  </a>
                  <a
                  ...
                  >
                    <Phone size={18} />
                    <span className="font-medium">Roshan: +91 9328818557</span>
                  </a>
                </div>
                <div className="hidden sm:flex items-center">
                  <span className="h-10 w-[1px] bg-gray-300" />
                </div>
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <span className="font-medium text-xl">WhatsApp</span>
                  </a>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full aspect-[4/3] max-w-2xl mx-auto rounded-3xl overflow-hidden drop-shadow-2xl">
                <img
                  src="/e04b5b68-3011-49d7-ba6d-741fcb5c735e.png"
                  alt="Car Gnee Premium Waterless Car Wash"
      ...
      <section className="py-12 bg-white border-y border-gray-100" ref={ref}>
                ...
                <p className="text-4xl lg:text-5xl font-bold text-[#2d8b3f] mb-2">
                  {inView ? (
                    <CountUp
                      ...
                      duration={2.5}
                      separator=","
                      suffix={stat.value.includes('+') ? '+' : stat.value.includes('L') ? 'L' : ''}
      ...
      <section className="py-24 gradient-bg">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <div className="inline-flex items-center bg-[#2d8b3f]/10 text-[#2d8b3f] px-4 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-xl lg:text-2xl font-extrabold mb-6 sm:mb-8 border-2 border-[#2d8b3f]/20 shadow-md min-h-[48px] sm:min-h-[64px] tracking-tight mx-auto">
              <Typewriter
                options={{
                  strings: [
                    'Our Services',
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <div className="text-center mb-8">
              <p className="text-lg sm:text-2xl lg:text-3xl font-semibold text-gray-700 max-w-2xl mx-auto mb-2 leading-relaxed">
                Simple, affordable plans for every car type.
              </p>
              <p className="text-lg sm:text-2xl lg:text-3xl font-semibold text-[#2d8b3f] max-w-2xl mx-auto leading-relaxed">
                No hidden charges.
              </p>
            </div>
            ...
            <div className="inline-flex bg-gray-100 rounded-full p-1.5">
              <motion.button
                ...
                className={`px-4 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-sm sm:text-lg transition-all ${
                  selectedPlan === "30"
                    ? "bg-[#2d8b3f] text-white shadow-lg"
      ...
      <section className="py-12 sm:pt-16 sm:pb-24 lg:pb-36 bg-[#2d2d2d] text-white">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <span className="inline-block bg-[#4ade80]/20 text-[#4ade80] px-5 sm:px-10 py-3 sm:py-5 rounded-full text-base sm:text-xl font-bold mb-6">
              Why Car Gnee
            </span>
            <h2 className="text-3xl sm:text-5xl lg:text-7xl font-bold mb-6 sm:mb-8">
              Why Choose Our Service?
            </h2>
            <p className="text-base sm:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
            {whyChooseUs.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="text-center p-6 sm:p-10 rounded-3xl bg-white/5 hover:bg-white/10 transition-colors"
              >
                <div className="w-16 h-16 sm:w-24 sm:h-24 rounded-3xl bg-[#2d8b3f] flex items-center justify-center mx-auto mb-6 sm:mb-8">
                  <item.icon size={32} className="text-white lg:hidden" /><item.icon size={48} className="text-white hidden lg:block" />
                </div>
                <h3 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4">{item.title}</h3>
                <p className="text-gray-400 text-sm sm:text-lg leading-relaxed">{item.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:pt-16 sm:pb-24 lg:pb-36 gradient-bg">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl sm:text-5xl lg:text-7xl font-bold text-[#2d2d2d] mb-6 sm:mb-8">
          ...
          >
            <Link to="/testimonials">
              <Button
                variant="outline"
                className="border-2 border-[#2d8b3f] text-[#2d8b3f] hover:bg-[#2d8b3f] hover:text-white px-10 py-7 text-xl rounded-full"
              >
                Read More Reviews
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 lg:gap-10">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="text-center p-5 sm:p-8 lg:p-12 rounded-3xl bg-[#d1f5e0] hover:shadow-xl transition-shadow"
              >
                <span className="text-4xl sm:text-6xl lg:text-7xl mb-3 sm:mb-6 block">{client.icon}</span>
                <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#2d8b3f] mb-1 sm:mb-2">
                  {client.count}
                </p>
                <p className="text-gray-600 text-xs sm:text-base lg:text-xl font-medium">{client.name}</p>
              </motion.div>
            ))}
          </div>
        </div>

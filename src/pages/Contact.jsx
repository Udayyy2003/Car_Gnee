...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      details: [
        { label: "Service Time", value: "5:00 AM - 7:30 AM" },
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center bg-[#2d8b3f]/10 text-[#2d8b3f] px-4 sm:px-10 py-3 sm:py-4 rounded-full text-sm sm:text-xl lg:text-2xl font-extrabold mb-6 sm:mb-8 border-2 border-[#2d8b3f]/20 shadow-md min-h-[44px] sm:min-h-[64px] tracking-tight mx-auto">
              <Typewriter
                options={{
                  strings: ['Contact Us', 'Get in Touch', 'We&apos;re Here to Help', 'Reach Out'],
                  autoStart: true,
                  loop: true,
                  deleteSpeed: 30,
                  delay: 50,
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-xl sm:text-3xl font-bold text-[#2d2d2d] mb-8">
                Send Us a Message
              </h2>

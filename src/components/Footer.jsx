          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-400">Uday: <a href="tel:+918160057141" className="hover:text-[#4ade80]">+91 8160057141</a></p>
                  <p className="text-gray-400">Roshan: <a href="tel:+919328818557" className="hover:text-[#4ade80]">+91 9328818557</a></p>
                </div>
              </li>
              <li className="flex items-start gap-3">

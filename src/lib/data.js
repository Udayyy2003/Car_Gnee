...
export const testimonials = [
  {
    ...
    location: "Ahmedabad",
    rating: 5,
    comment: "Car Gnee has been cleaning my Honda City for 3 months now. The waterless cleaning is amazing - my car looks showroom fresh every day! Highly recommend their 30-day plan.",
    carType: "Sedan",
    date: "2024-01-15",
  },
  {
  ...
  },
  {
    ...
    location: "Vadodara",
    rating: 5,
    comment: "As a hatchback owner, I was worried about finding a good service. Car Gnee exceeded all expectations! My Swift shines like new every time.",
    carType: "Hatchback",
    date: "2024-02-01",
  },
  {
...
export const faqs = [
  ...
  },
  {
    ...
    answer: "For best results, we recommend our 30-day plan with daily cleaning. This keeps your car consistently clean and protected. If daily cleaning isn't necessary for your needs, our 15-day alternate day plan is also excellent for maintaining your vehicle.",
  },
  {
  ...
  },
  {
    ...
    answer: "Our standard service hours are from 5:00 AM to 7:30 AM. This ensures your car is clean and ready before you start your day. We can discuss specific timing based on your convenience.",
  },
  {
...
export const planTypes = [
  ...
  { value: "30", label: "30 Days Plan (Daily)" },
];
